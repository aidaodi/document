...
```shell
   ...
   #为应用签名
   java -jar hap-sign-tool.jar sign-app -keyAlias "v2distribution" -signAlg "SHA256withECDSA" -mode "localSign" -appCertFile "blt2Mqtt.cer" -profileFile "Blt2MqttServerDebug.p7b" -inFile "blt.hap" -keystoreFile "v2distribution.p12" -outFile "result\blt.hap" -keyPwd "daheng123Abc" -keystorePwd "daheng123Abc" -signCode "1"
```
